...
data "azurerm_user_assigned_identity" "example" {
  name                = "aks-basic-tf-2810-dev"      # Replace with the name of your existing user-assigned identity
  resource_group_name = "aks-basic-tf-2810-identity" # Replace with the resource group name where the identity is located
}
